...
st.header("Thidarat Thongsin")

st.balloons()
st.title('การทดสอบเขียนเว็บด้วย Python')
st.header('นางสาว ธิดารัตน์ ทองสินธุ์')
...
with col2:
    st.image('./pic/ดอกขาวๆ.jpg')

html_1 = """
<div style="background-color:#FA8072;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
...
if st.button("ทำนายผล"):
   ...
   if out[0]=="Setosa":
      st.image("./pic/ดอกคอก.jpg")
      #st.header("Setosa")
   elif out[0]=="Versicolor":
      st.image("./pic/ดอกม่วง.jpg")
